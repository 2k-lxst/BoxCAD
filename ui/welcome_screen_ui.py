...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnCreateProject.setGeometry(QRect(50, 194, 171, 41))
        self.btnDocs = QPushButton(self.centralwidget)
        self.btnDocs.setObjectName(u"btnDocs")
        self.btnDocs.setGeometry(QRect(60, 295, 151, 36))
        self.btnExit = QPushButton(self.centralwidget)
        self.btnExit.setObjectName(u"btnExit")
        self.btnExit.setGeometry(QRect(70, 350, 131, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelVersion.setText(QCoreApplication.translate("MainWindow", u"v1.0.0", None))
        self.btnCreateProject.setText(QCoreApplication.translate("MainWindow", u"Create New Project", None))
        self.btnDocs.setText(QCoreApplication.translate("MainWindow", u"Docs", None))
        ...
        self.progressBar.setFormat(QCoreApplication.translate("MainWindow", u"Ready", None))
